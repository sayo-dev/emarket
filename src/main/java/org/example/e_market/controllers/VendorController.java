...
public class VendorController {
    ...
    @PutMapping("/profile")
    public ResponseEntity<ApiResponse<Void>> updateStoreProfile(@Valid @RequestBody UpdateVendorProfileRequest request) {
    ...
    public ResponseEntity<ApiResponse<VendorResponse>> getEarningsSummary() {
        return ResponseEntity.ok(ApiResponse.success("Earnings summary fetched successfully", vendorService.getEarningsSummary()));
    }

    @GetMapping("/payouts")
    public ResponseEntity<ApiResponse<List<PayoutResponse>>> getPayoutHistory() {
        return ResponseEntity.ok(ApiResponse.success("Payout history fetched successfully", vendorService.getPayoutHistory()));
    }
